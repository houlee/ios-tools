...
@implementation GoalsForCell
@synthesize wangqibool, panduan;
@synthesize butTitle;
@synthesize delegate;
@synthesize row, XIDANImageView, typeButtonArray;
@synthesize jcbool, danguanbool;
- (void)dealloc{
...
//            [sender setImage:UIImageGetImageFromName(@"shedanxuanzhogn.png") forState:UIControlStateNormal];
            bgimage.hidden = YES;
            bgimage2.hidden = NO;
//            changhaola.textColor  = [UIColor whiteColor];
        }else{
//            [sender setImage:UIImageGetImageFromName(@"yibanxuanzhong.png") forState:UIControlStateNormal];
            bgimage.hidden = NO;
            bgimage2.hidden = YES;
//            changhaola.textColor  = [UIColor colorWithRed:69/255.0 green:69/255.0 blue:69/255.0 alpha:1];
        ...
        if ([betData.jiantouArray count]-1 >= sender.tag - 1) {
            if ([[betData.jiantouArray objectAtIndex:sender.tag - 1] isEqualToString:@"1"]) {
                //            jianImage.image = UIImageGetImageFromName(@"baijiantous.png");
                ...
                //            jianImage.image = UIImageGetImageFromName(@"baijiantoux.png");
                jianImage.hidden = YES;
                jianImage2.hidden = YES;
...
//        changhaola.textColor  = [UIColor colorWithRed:69/255.0 green:69/255.0 blue:69/255.0 alpha:1];
//        [sender setImage:UIImageGetImageFromName(@"bdzjq.png") forState:UIControlStateNormal];
        bgimage.hidden = YES;
        bgimage2.hidden = YES;
...
//            if ([betData.jiantouArray count]< 8) {
//                return;
//            }
//        }
        if ([betData.jiantouArray count]-1 >= sender.tag - 1) {
            if ([[betData.jiantouArray objectAtIndex:sender.tag - 1] isEqualToString:@"1"]) {
                //            jianImage.image = UIImageGetImageFromName(@"gc_shang.png");
                //            jianImage.hidden = NO;
                jianImage.hidden = NO;
                jianImage2.hidden = YES;
                jianImage3.hidden = YES;
                ...
                //            jianImage.image = UIImageGetImageFromName(@"gc_xiangxia.png");
...
- (void)setBetData:(GC_BetData *)_betData{
    ...
    if ([betData.bufshuarr count] < 8) {
        betData.bufshuarr = [NSMutableArray arrayWithObjects:@"0", @"0",@"0",@"0",@"0",@"0",@"0",@"0", nil];
    }
...
//    XIDANImageView.image = UIImageGetImageFromName(@"shengpingfunew1.png");
    ...
    NSArray * caiguo = [NSArray arrayWithObjects:@"0", @"1", @"2", @"3", @"4", @"5", @"6", @"7+", nil];
    
//    if ([_betData.oupeiarr count] < 8) {
//        return;
//    }
    NSLog(@"aaaaaaaaaaaaaaaaaaaaa %ld %@      %d   %d" ,(long)row.row, _betData.onePlural, wangqibool, jcbool);
    if ([_betData.onePlural rangeOfString:@" 0,"].location == NSNotFound && [_betData.onePlural rangeOfString:@" 3,"].location == NSNotFound && jcbool) {//判断 是否是单复式
        if (danguanbool) {
    ...
    if (wangqibool && jcbool) {
        _betData.bufshuarr = [NSMutableArray arrayWithObjects:@"0", @"0",@"0",@"0",@"0",@"0",@"0",@"0", nil];
    }
...
//            [itemButton setImage:UIImageGetImageFromName(@"bdzjq.png") forState:UIControlStateNormal];//平常的
...
//            bgimage2.image=  UIImageGetImageFromName(@"shedanxuanzhogn.png");
            ...
            UILabel * noLable = [[UILabel alloc] initWithFrame:CGRectMake(16.5, (32- 17)/2+2, 12, 17)];
            ...
            noLable.font = [UIFont fontWithName:@"04b" size:17];
            //    tianDateLabel.font = [UIFont boldSystemFontOfSize:59];
            ...
            if (tagInt == 9) {
                UIImageView * noImage = [[UIImageView alloc] initWithFrame:CGRectMake(16.5, (32- 10.5)/2, 6.5, 10.5)];
                noImage.backgroundColor = [UIColor clearColor];
                NSString * str = [NSString stringWithFormat:@"Normal%d.png", (int)tagInt];
                noImage.image = UIImageGetImageFromName(str);
                [itemButton addSubview:noImage];
                [noImage release];
                noImage.frame = CGRectMake((82.5 - 18.5)/2, (32 - 13)/2, 18.5, 13);
                itemButton.enabled = NO;
                noLable.text = @"";
            }else{
                
                
                UILabel * labelItem = [[UILabel alloc] initWithFrame:CGRectMake(16.5+12, 0, 39.5, 32)];
...
//                labelItem.text = @"12.22";
                ...
                UIImageView * jiantou = [[UIImageView alloc] initWithFrame:CGRectMake(82.5 - 5 - 7, (32 - 7)/2+1, 7, 7)];
                ...
                [jiantou release];
                UIImageView * jiantou2 = [[UIImageView alloc] initWithFrame:CGRectMake(82.5 - 5 - 7, (32 - 7)/2+1, 7, 7)];
                ...
                jiantou2.hidden = YES;
                [jiantou2 release];
                UIImageView * jiantou3 = [[UIImageView alloc] initWithFrame:CGRectMake(82.5 - 5 - 7, (32 - 7)/2+1, 7, 7)];
                ...
                [jiantou3 release];
                UIImageView * jiantou4 = [[UIImageView alloc] initWithFrame:CGRectMake(82.5 - 5 - 7, (32 - 7)/2+1, 7, 7)];
                ...
                if (tagInt == 8) {
                     noLable.text = [NSString stringWithFormat:@"%d+", (int)tagInt-1];
                    noLable.frame = CGRectMake(16.5, (32- 17)/2+2, 17, 17);
                    labelItem.frame = CGRectMake(16.5+17, 0, 34.5, 32);
                }else{
                     noLable.text = [NSString stringWithFormat:@"%d", (int)tagInt-1];
                }
            }
...
//    xidanButton.hidden = YES;
    ...
    butTitle.frame = CGRectMake(0, 52, 56, 20);
...
- (void)contenOffSetXYFunc{
    ...
    if (self.butonScrollView.contentOffset.x >= xcount/2) {
...
//        self.butonScrollView.contentOffset = CGPointMake(xcount, 0);
        XIDANImageView.image = UIImageGetImageFromName(@"xidanhuakai.png");
    }else if (self.butonScrollView.contentOffset.x < xcount/2) {
        if (delegate && [delegate respondsToSelector:@selector(returnCellContentOffsetString:remove:)]) {
            NSIndexPath * path = [NSIndexPath indexPathForRow:row.row inSection:row.section];
