...
//注：专家和高手公用的UItableviewCell

#import "ExpertSuperiorBaseCell.h"
#import "caiboAppDelegate.h"

@implementation ExpertSuperiorBaseCell
...
+(id)ExpertSuperiorBaseCellWithTableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ExpertSuperiorBaseCell * cell=[tableView cellForRowAtIndexPath:indexPath];
    if (cell==nil) {
        cell=[[ExpertSuperiorBaseCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:superiorCellId];
    }
...
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self=[super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        UILabel * dueOfTwoSides2=[[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(headImageView.frame)+15, CGRectGetMaxY(time.frame)+8, 150, 20)];
        dueOfTwoSides2.font=FONTTHIRTY;
        dueOfTwoSides2.textColor=[UIColor blackColor];
        dueOfTwoSides2.alpha=0.87;
        [self.contentView addSubview:dueOfTwoSides2];
        self.name2=dueOfTwoSides2;
        
        UILabel * time2=[[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(headImageView.frame)+15, CGRectGetMaxY(dueOfTwoSides2.frame)+8, 80, 20)];
        time2.font=FONTTWENTY_FOUR;
        time2.textColor=[UIColor blackColor];
        time2.alpha=0.54;
        [self.contentView addSubview:time2];
        self.time2=time2;
        
        //类型2
        UILabel * matchType2=[[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(time.frame)+37.5,time2.frame.origin.y, 40, 20)];
        matchType2.font=FONTTWENTY_FOUR;
        matchType2.textColor=[UIColor blackColor];
        matchType2.alpha=0.87;
        [self.contentView addSubview:matchType2];
        self.league2=matchType2;
        
        //类型
        UILabel * matchType=[[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(time.frame)+37.5,time.frame.origin.y, 40, 20)];
        matchType.font=FONTTWENTY_FOUR;
        matchType.textColor=[UIColor blackColor];
        matchType.alpha=0.87;
...
-(void)setCellSuperHead:(NSString *)head name:(NSString *)name starNo:(NSInteger)starNo odds:(NSString *)odds matchSides:(NSString *)matchSides time:(NSString *)time leagueType:(NSString *)leagueType exPrice:(float)exPrice exDiscount:(float)discount exRank:(NSInteger)exRank refundOrNo:(NSInteger)refundOrNo flag:(BOOL)flag lotryTp:(NSString *)lotryTp
{
    ...
    _time2.hidden = YES;
    _league2.hidden = YES;
    _line.frame = CGRectMake(0,99.5, MyWidth, 0.5);
    ...
    if ([lotryTp isEqualToString:@"204"]){
        self.twoSideLab.numberOfLines = 2;
        self.twoSideLab.frame=CGRectMake(self.nickNamelab.frame.origin.x, CGRectGetMaxY(self.nickNamelab.frame)+4, MyWidth-75, 35);
    }
    ...
    if([lotryTp isEqualToString:@"204"]){
        self.timeLab.frame=CGRectMake(self.nickNamelab.frame.origin.x, CGRectGetMaxY(self.twoSideLab.frame), 136, 20);
    }
...
//#endif
    ...
    self.leagueTypeLab.frame=CGRectMake(CGRectGetMinX(self.priceLab.frame)-cellUIsize.width-10,_timeLab.frame.origin.y, cellUIsize.width, rect.size.height);
    ...
    if([lotryTp isEqualToString:@"204"]){//篮球
        ...
        if (range.location == NSNotFound) {
            range = [matchSides rangeOfString:@" "];
        }
        if (range.location != NSNotFound) {
            ...
            [aString addAttribute:NSParagraphStyleAttributeName value:paragraphStyle range:NSMakeRange(0, [matchSides length])];
...
-(void)HeadImageView:(NSString * )HeadImageView vImageView:(NSString *)vImageView nickName:(NSString *)nickName levels:(NSString *)levels statics:(NSString *)statics dueOfTwoSides:(NSString *)dueOfTwoSides time:(NSString *)time price:(NSString *)price flag:(NSString *)flag refundOrNo:(NSInteger)refundOrNo lotryTp:(NSString *)lotryTp
{
    ...
    //赛名英超
    cellUIsize=[PublicMethod setNameFontSize:self.leagueTypeLab.text andFont:FONTTWENTY_FOUR andMaxSize:CGSizeMake(MAXFLOAT, MAXFLOAT)];
    self.leagueTypeLab.frame=CGRectMake(CGRectGetMaxX(self.timeLab.frame)+37.5,self.timeLab.frame.origin.y, cellUIsize.width, cellUIsize.height);
...
-(void)setCellSuperHead:(NSString *)head name:(NSString *)name starNo:(NSInteger)starNo odds:(NSString *)odds matchSides:(NSString *)matchSides time:(NSString *)time leagueType:(NSString *)leagueType exPrice:(float)exPrice exDiscount:(float)discount exRank:(NSInteger)exRank refundOrNo:(NSInteger)refundOrNo flag:(BOOL)flag lotryTp:(NSString *)lotryTp name2:(NSString *)name2 time2:(NSString *)time2 league2:(NSString *)league2{
...
//#endif
    ...
    rect=_league2.frame;
    rect.origin.x=CGRectGetMinX(self.priceLab.frame)-cellUIsize.width-10;
    ...
    self.line.frame = CGRectMake(0,99.5+56, MyWidth, 0.5);
}
