...
@interface ShiShiCaiViewController : CPViewController<GCBallViewDelegate,ASIHTTPRequestDelegate,UIPickerViewAccessibilityDelegate,CP_ThreeLevelNavDelegate,CP_KindsOfChooseDelegate,GifButtonDelegate,CP_UIAlertViewDelegate> {
