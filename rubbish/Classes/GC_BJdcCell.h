...
@protocol GC_BJdcCellDelegate <NSObject>
@optional
...
@interface GC_BJdcCell : CP_CanOpenCell<UIScrollViewDelegate>{
    ...
    id<GC_BJdcCellDelegate>delegate;
    UIButton * button1;
    UIButton * button2;
    UIButton * button3;
    NSIndexPath * row;
...
@property (nonatomic, assign)id<GC_BJdcCellDelegate>delegate;
