...
@interface KFMessageViewController : UIViewController<UIActionSheetDelegate, UITableViewDataSource, UITableViewDelegate, UITextViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate, KFSiXinCellDelegate>

{
    ...
    UpLoadView * loadview;
    NewPostViewController * newpost;
    BOOL newpostBool;
    
    CP_PTButton * photoButton;
}
...
@property (nonatomic, retain)NewPostViewController * newpost;
