...
{
	NSString *string = [NSString stringWithFormat:@"%d%02d%02d",(int)[self getYear],(int)[self getMonth],(int)[self getDay]];
	return string;
}

- (NSString *)getFormatYearMonthDayHour {
    NSString *string = [NSString stringWithFormat:@"%d%02d%02d%02d",(int)[self getYear],(int)[self getMonth],(int)[self getDay],(int)[self getHour]];
    return string;
}
...
+ (NSDate *)jcDateFromString:(NSString *)string withFormat:(NSString *)format {
...
+ (NSDate *)jcDateFromString:(NSString *)string {
	return [NSDate jcDateFromString:string withFormat:[NSDate dbFormatString]];
}
...
- (NSString *)jcStringWithFormat:(NSString *)format {
	NSDateFormatter *outputFormatter = [[NSDateFormatter alloc] init];
//	[outputFormatter setDateFormat:format];
...
- (NSString *)jcString {
	return [self jcStringWithFormat:[NSDate dbFormatString]];
}
- (NSString *)string {
