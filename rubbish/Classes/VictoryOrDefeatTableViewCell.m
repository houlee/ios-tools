//
//  VictoryOrDefeatTableViewCell.m
//  caibo
//
...
@implementation VictoryOrDefeatTableViewCell
...
- (void)showMatchLogoImage:(NSString *)logoName{
    
    if ([logoName isEqualToString:@"足球"]) {
        matchLogoImage.image = UIImageGetImageFromName(@"zuqiulogoimage.png");
    }else if ([logoName isEqualToString:@"篮球"]){
        matchLogoImage.image = UIImageGetImageFromName(@"lanqiulogoimage.png");
    }else if ([logoName isEqualToString:@"网球"]){
        matchLogoImage.image = UIImageGetImageFromName(@"wangqiulogoimage.png");
    }else if ([logoName isEqualToString:@"橄榄球"]){
        matchLogoImage.image = UIImageGetImageFromName(@"ganlanqiulogoimage.png");
    }else if ([logoName isEqualToString:@"排球"]){
        matchLogoImage.image = UIImageGetImageFromName(@"paiqiulogoimage.png");
    }else if ([logoName isEqualToString:@"羽毛球"]){
        matchLogoImage.image = UIImageGetImageFromName(@"ymqlogoimage.png");
    }else if ([logoName isEqualToString:@"乒乓球"]){
        matchLogoImage.image = UIImageGetImageFromName(@"ppqlogoimage.png");
    }else if ([logoName isEqualToString:@"沙滩排球"]){
        matchLogoImage.image = UIImageGetImageFromName(@"stpqlogoimage.png");
    }else if ([logoName isEqualToString:@"冰球"]){
        matchLogoImage.image = UIImageGetImageFromName(@"bingqiulogoimage.png");
    }else if ([logoName isEqualToString:@"曲棍球"]){
        matchLogoImage.image = UIImageGetImageFromName(@"qgqlogoimage.png");
    }else if ([logoName isEqualToString:@"手球"]){
        matchLogoImage.image = UIImageGetImageFromName(@"shouqiulogoimage.png");
    }else if ([logoName isEqualToString:@"水球"]){
        matchLogoImage.image = UIImageGetImageFromName(@"shuiqiulogoimage.png");
    }else {
        matchLogoImage.image = nil;
    }
...
- (void)jianThouShowFunc{
    
    UIImageView  * jianImage1 = (UIImageView *)[button1 viewWithTag:1000];
    UIImageView  * jianImage2 = (UIImageView *)[button1 viewWithTag:1001];
    UIImageView  * jianImage3 = (UIImageView *)[button1 viewWithTag:1002];
    UIImageView  * jianImage4 = (UIImageView *)[button1 viewWithTag:1003];
    
    UIImageView  * jianImage12 = (UIImageView *)[button2 viewWithTag:1000];
    UIImageView  * jianImage22 = (UIImageView *)[button2 viewWithTag:1001];
    UIImageView  * jianImage32 = (UIImageView *)[button2 viewWithTag:1002];
    UIImageView  * jianImage42 = (UIImageView *)[button2 viewWithTag:1003];
    
//    UIImageView  * jianImage13 = (UIImageView *)[button3 viewWithTag:1000];
//    UIImageView  * jianImage23 = (UIImageView *)[button3 viewWithTag:1001];
//    UIImageView  * jianImage33 = (UIImageView *)[button3 viewWithTag:1002];
//    UIImageView  * jianImage43 = (UIImageView *)[button3 viewWithTag:1003];
    
    if (pkbetdata.selection1) {
        
        if ([pkbetdata.xianshi1 isEqualToString:@"1"]) {
            jianImage1.hidden = YES;
            jianImage2.hidden = YES;
            jianImage3.hidden = NO;
            jianImage4.hidden = YES;
        }else if ([pkbetdata.xianshi1 isEqualToString:@"2"]){
            jianImage1.hidden = YES;
            jianImage2.hidden = YES;
    ...
    if (pkbetdata.selection2){
        if ([pkbetdata.xianshi2 isEqualToString:@"1"]) {
            jianImage12.hidden = YES;
            jianImage22.hidden = YES;
            jianImage32.hidden = NO;
            jianImage42.hidden = YES;
        }else if ([pkbetdata.xianshi2 isEqualToString:@"2"]){
            jianImage12.hidden = YES;
            jianImage22.hidden = YES;
            jianImage32.hidden = YES;
            jianImage42.hidden = NO;
        }else{
            jianImage12.hidden = YES;
            jianImage22.hidden = YES;
            jianImage32.hidden = YES;
        ...
        if ([pkbetdata.xianshi2 isEqualToString:@"1"]) {
            jianImage12.hidden = NO;
            jianImage22.hidden = YES;
            jianImage32.hidden = YES;
            jianImage42.hidden = YES;
        }else if ([pkbetdata.xianshi2 isEqualToString:@"2"]){
            jianImage12.hidden = YES;
            jianImage22.hidden = NO;
            jianImage32.hidden = YES;
            jianImage42.hidden = YES;
        }else{
            jianImage12.hidden = YES;
...
//    if (pkbetdata.selection3){
//        if ([pkbetdata.xianshi3 isEqualToString:@"1"]) {
//            jianImage13.hidden = YES;
//            jianImage23.hidden = YES;
//            jianImage33.hidden = NO;
//            jianImage43.hidden = YES;
//        }else if ([pkbetdata.xianshi3 isEqualToString:@"2"]){
//            jianImage13.hidden = YES;
//            jianImage23.hidden = YES;
//            jianImage33.hidden = YES;
//            jianImage43.hidden = NO;
//        }else{
//            jianImage13.hidden = YES;
//            jianImage23.hidden = YES;
//            jianImage33.hidden = YES;
...
//    }else{
//        if ([pkbetdata.xianshi3 isEqualToString:@"1"]) {
//            jianImage13.hidden = NO;
//            jianImage23.hidden = YES;
//            jianImage33.hidden = YES;
//            jianImage43.hidden = YES;
//        }else if ([pkbetdata.xianshi3 isEqualToString:@"2"]){
//            jianImage13.hidden = YES;
//            jianImage23.hidden = NO;
//            jianImage33.hidden = YES;
//            jianImage43.hidden = YES;
//        }else{
//            jianImage13.hidden = YES;
...
//    }
    ...
    if ([[teamarray objectAtIndex:2] floatValue] == 0) {
        ...
        rangqiulabel.frame = CGRectMake(button1.frame.size.width - 40 - 5, 0, 40, 20);
    }
    ...
    [self showMatchLogoImage:_pkbetdata.matchLogo];
...
//            winImage3.hidden = YES;
        ...
        if ([_pkbetdata.matchLogo isEqualToString:@"足球"] || [_pkbetdata.matchLogo isEqualToString:@"篮球"]) {
        
            xidanButton.enabled = YES;
        }else{
            xidanButton.enabled = NO;
...
//        winImage3.hidden = YES;
    ...
    if (row.row == 0) {
        datalImage1.hidden = NO;
        datalImage2.hidden = NO;
//        datal3.hidden = NO;
//        if (selection1) {
...
//        }
        ...
        datalImage1.hidden = YES;
        datalImage2.hidden = YES;
//        datal3.hidden = YES;
    }
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier type:(NSString *)type chaodan:(BOOL)chaodan
{
    ...
    if (self) {
        ...
        self.butonScrollView.frame = CGRectMake(self.butonScrollView.frame.origin.x, 23+3, self.butonScrollView.frame.size.width, 81);
...
//    headimage.image = UIImageGetImageFromName(@"bjbeidan.png");
    ...
    rangqiulabel.textAlignment = NSTextAlignmentRight;
    ...
    //第一个button上的小数字
    butLabel1 = [[UILabel alloc] initWithFrame:CGRectMake(0, (60-15)/2, 90, 15)];
    ...
    //第二个button上的小数字
    butLabel2 = [[UILabel alloc] initWithFrame:CGRectMake(0, (60-15)/2, 69, 15)];
...
//    butLabel3.font = [UIFont systemFontOfSize:14];
    ...
    UIImageView * logoImage = [[UIImageView alloc] initWithFrame:CGRectMake(0.5, 0, 83.5, 51)];
    logoImage.backgroundColor =[UIColor colorWithRed:255/255.0 green:253/255.0 blue:247/255.0 alpha:1];
//    logoImage.image = UIImageGetImageFromName(@"matchlogoimage.png");
    [view addSubview:logoImage];
    [logoImage release];
    
    matchLogoImage = [[UIImageView alloc] initWithFrame:CGRectMake((logoImage.frame.size.width - 50)/2, -2.5, 50, 54.5)];
    matchLogoImage.backgroundColor = [UIColor clearColor];
    [logoImage addSubview:matchLogoImage];
    [matchLogoImage release];
    ...
    button1.frame = CGRectMake(84.5, 0, 83.5, 51);
    ...
    button2.frame = CGRectMake(168.5, 0, 83.5, 51);
...
//    [button1 setImage:UIImageGetImageFromName(@"matcsfimage.png") forState:UIControlStateNormal];
//    [button2 setImage:UIImageGetImageFromName(@"matcsfimage.png") forState:UIControlStateNormal];
...
//        bgimage2.image=  UIImageGetImageFromName(@"rqspfbgxuandan.png");
        ...
        UIImageView * jiantou = [[UIImageView alloc] initWithFrame:CGRectMake(83.5 - 5 - 7, (51 - 7)/2+1, 7, 7)];
        jiantou.tag =  1000;
        ...
        UIImageView * jiantou2 = [[UIImageView alloc] initWithFrame:CGRectMake(83.5 - 5 - 7, (51 - 7)/2+1, 7, 7)];
        jiantou2.backgroundColor = [UIColor clearColor];
        jiantou2.tag = 1001;
        jiantou2.image = UIImageGetImageFromName(@"gc_xiangxia.png");
        jiantou2.hidden = YES;
        
        UIImageView * jiantou3 = [[UIImageView alloc] initWithFrame:CGRectMake(83.5 - 5 - 7, (51 - 7)/2+1, 7, 7)];
        ...
        UIImageView * jiantou4 = [[UIImageView alloc] initWithFrame:CGRectMake(83.5 - 5 - 7, (51 - 7)/2+1, 7, 7)];
...
//            [bgimage2 release];
//            [button3 addSubview:jiantou];
//            [jiantou release];
//            [button3 addSubview:jiantou2];
//            [jiantou2 release];
//            [button3 addSubview:jiantou3];
//            [jiantou3 release];
//            [button3 addSubview:jiantou4];
//            [jiantou4 release];
...
//    [view addSubview:button3];
    ...
    bifenLabel = [[UILabel alloc] initWithFrame:CGRectMake(148, 16, 205-138 - 17, 14)];
...
//    ddd bdsfxidanimage   rangqiuguan.png
...
//    datal3.text = @"负";
    ...
    datalImage1 = [[UIImageView alloc] initWithFrame:CGRectMake(1.5, 1.5, 12.5, 12.5)];
    datalImage1.backgroundColor = [UIColor clearColor];
    datalImage1.image = UIImageGetImageFromName(@"bdsfshengimage.png");
    [button1 addSubview:datalImage1];
    [datalImage1 release];
    
    datalImage2 = [[UIImageView alloc] initWithFrame:CGRectMake(1.5, 1.5, 12.5, 12.5)];
    datalImage2.backgroundColor = [UIColor clearColor];
    datalImage2.image = UIImageGetImageFromName(@"bdsffuimage.png");
    [button2 addSubview:datalImage2];
    [datalImage2 release];
    ...
    zhegaiview.frame=  CGRectMake(0, 0, 310-56, 60);
