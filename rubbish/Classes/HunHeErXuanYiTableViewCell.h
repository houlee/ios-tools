...
@protocol HunHeErXuanYiDelegate <NSObject>
@optional
...
@interface HunHeErXuanYiTableViewCell : CP_CanOpenCell<UIScrollViewDelegate>{
...
//    UILabel * butLabel3;//第三个按钮上的小数字
    ...
    id<HunHeErXuanYiDelegate>delegate;
    UIButton * button1;
    UIButton * button2;
//    UIButton * button3;
    NSIndexPath * row;
...
@property (nonatomic, assign)id<HunHeErXuanYiDelegate>delegate;
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier type:(NSString *)type chaodan:(BOOL)chaodan;@end
