...
@protocol BDHalfCellDelegate <NSObject>
...
@interface BDHalfCell : CP_CanOpenCell<UIScrollViewDelegate>{
    UIButton * zhegaiview;
    ...
    UILabel * butTitle;
    GC_BetData * betData;
    id<BDHalfCellDelegate> delegate;
    NSIndexPath * row;
...
@property (nonatomic, assign)id<BDHalfCellDelegate>delegate;
