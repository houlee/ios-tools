...
@protocol PK_TableCellDelegate <NSObject>
@optional
...
@interface PK_TableCell : CP_CanOpenCell{
    ...
    id<PK_TableCellDelegate>delegate;
    UIButton * button1;
    UIButton * button2;
    UIButton * button3;
    NSInteger row;
...
@property (nonatomic, assign)id<PK_TableCellDelegate>delegate;
