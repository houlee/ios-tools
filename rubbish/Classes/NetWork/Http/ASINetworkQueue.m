...
- (void)addOperation:(NSOperation *)operation
{
    ...
    [[request requestHeaders] setValue:[UDIDFromMac uniqueGlobalDeviceIdentifier] forKey:@"macCode"];
    [[request requestHeaders] setValue:[NSString stringWithFormat:@"%@_%@",Name,[[Info getInstance] cbVersion]] forKey:@"versinoNum"];
    [[request requestHeaders] setValue:newVersionKey forKey:@"newVersion"];
