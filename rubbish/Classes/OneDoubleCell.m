...
//            if ([betData.jiantouArray count]< 4) {
//                return;
//            }
//        }
...
- (void)setBetData:(GC_BetData *)_betData{
    ...
    if ([betData.bufshuarr count] < 4) {
        betData.bufshuarr = [NSMutableArray arrayWithObjects:@"0", @"0",@"0",@"0", nil];
    }
...
//    XIDANImageView.image = UIImageGetImageFromName(@"shengpingfunew1.png");
    ...
    //    NSInteger count = 1;
    NSArray * caiguo = [NSArray arrayWithObjects:@"上单", @"上双", @"下单", @"下双", nil];
//    if ([_betData.oupeiarr count] < 4) {
//        return;
//    }
...
//        }
        ...
        if (wangqibool && [_betData.caiguo isEqualToString:[caiguo objectAtIndex:i]]) {
            ...
            winImage.hidden = NO;
//            NSString * str = [NSString stringWithFormat:@"redanshuang%d.png", i+1];
//            imageItem.image = UIImageGetImageFromName(str);
...
//    headimage.image = UIImageGetImageFromName(@"bjbeidan.png");
    ...
    for (int i = 0; i < 2; i++) {
        for (int j = 0; j < 2; j++) {
            ...
            itemButton.frame = CGRectMake(j*126.25+(j* 0.5), i*32 + (i*0.5), 126.25, 32);
//            [itemButton setImage:UIImageGetImageFromName(@"touzhubgbd.png") forState:UIControlStateNormal];
//            [itemButton setImage:UIImageGetImageFromName(@"touzhubgbd.png") forState:UIControlStateDisabled];
...
//            bgimage.image = UIImageGetImageFromName(@"sxdsxuanzhong.png");
...
//            bgimage2.image=  UIImageGetImageFromName(@"sxdsshedan.png");
            [itemButton addSubview:bgimage2];
            [bgimage2 release];
            
//            UIImageView * noImage = [[UIImageView alloc] initWithFrame:CGRectMake(23, (32- 10)/2, 32, 10)];
//            noImage.backgroundColor = [UIColor clearColor];
//            noImage.tag = tagInt*10;
//             NSString * str = [NSString stringWithFormat:@"danshuang%d.png", tagInt];
//            noImage.image = UIImageGetImageFromName(str);
//            [itemButton addSubview:noImage];
//            [noImage release];
            
            UILabel * noLable = [[UILabel alloc] initWithFrame:CGRectMake(23, (32- 17)/2, 32, 18)];
            ...
            UILabel * labelItem = [[UILabel alloc] initWithFrame:CGRectMake(23+32, 0, 46, 32)];
...
//            labelItem.text = @"12.22";
            ...
            UIImageView * jiantou = [[UIImageView alloc] initWithFrame:CGRectMake(123.5 - 14 - 7, (32 - 7)/2+1, 7, 7)];
            ...
            UIImageView * jiantou2 = [[UIImageView alloc] initWithFrame:CGRectMake(123.5 - 14 - 7, (32 - 7)/2+1, 7, 7)];
            ...
            jiantou2.hidden = YES;
            [jiantou2 release];
            UIImageView * jiantou3 = [[UIImageView alloc] initWithFrame:CGRectMake(123.5 - 14 - 7, (32 - 7)/2+1, 7, 7)];
            ...
            [jiantou3 release];
            UIImageView * jiantou4 = [[UIImageView alloc] initWithFrame:CGRectMake(123.5 - 14 - 7, (32 - 7)/2+1, 7, 7)];
    ...
    UIView * linebutton3 = [[UIView alloc] initWithFrame:CGRectMake(126.25, 0, 0.5, 97)];
    ...
    UIView * linebutton4 = [[UIView alloc] initWithFrame:CGRectMake(253, 0, 0.5, 97)];
    ...
    zhegaiview.frame= CGRectMake(0, 0, 257, view.frame.size.height);
...
//             = [NSIndexPath indexPathForRow:row.row inSection:row.section];
            ...
            NSLog(@"delegate = %d   %d", (int)path.row , (int)path.section);
...
//            NSIndexPath * path = [NSIndexPath indexPathForRow:row.row inSection:row.section];
            ...
            NSLog(@"delegateaaa = %d   %d", (int)path.row , (int)path.section);
        }
        XIDANImageView.image = UIImageGetImageFromName(@"guanbixidanimage.png");
    }
